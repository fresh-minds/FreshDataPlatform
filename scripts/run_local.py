...
Usage:
    python scripts/run_local.py --pipeline job_market_nl.bronze_adzuna_jobs
...
Examples:
  python scripts/run_local.py --pipeline job_market_nl.bronze_adzuna_jobs
  python scripts/run_local.py --domain job_market_nl --layer bronze
  python scripts/run_local.py --list
  python scripts/run_local.py --pipeline job_market_nl.bronze_adzuna_jobs --dry-run
        """,
    )
    parser.add_argument(
        "--pipeline",
