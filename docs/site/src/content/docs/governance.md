---
title: Governance
description: Operating model, ownership, data quality, and lifecycle management.
order: 6
---
...
| Decision | Owner | Steward | Platform | Security | Council |
|----------|-------|---------|----------|----------|---------|
...
| AI model promotion (regulated) | C | C | R | C | A |
