"""ODP Staffing Demand pipeline that writes directly to the Postgres warehouse.
...
- odp_staffing_demand.harvey_nash_vacatures (source table for Harvey Nash NL vacatures)
"""
...
from pipelines.odp_staffing_demand.utils import extract_skills_from_text
...
def ensure_tables(conn) -> None:
    with conn.cursor() as cur:
        cur.execute("CREATE SCHEMA IF NOT EXISTS odp_staffing_demand")
        cur.execute(
            """
            CREATE TABLE IF NOT EXISTS odp_staffing_demand.it_market_snapshot (
        ...
        cur.execute(
            """
            CREATE TABLE IF NOT EXISTS odp_staffing_demand.it_market_top_skills (
              skill TEXT NOT NULL,
        ...
        cur.execute(
            """
            CREATE TABLE IF NOT EXISTS odp_staffing_demand.it_market_region_distribution (
        ...
        cur.execute(
            """
            CREATE TABLE IF NOT EXISTS odp_staffing_demand.it_market_job_ads_geo (
        ...
        cur.execute(
            """
            CREATE TABLE IF NOT EXISTS odp_staffing_demand.harvey_nash_vacatures (
              id TEXT NOT NULL,
              title TEXT,
              company TEXT,
              location TEXT,
        ...
        cur.execute(
            """
            CREATE TABLE IF NOT EXISTS odp_staffing_demand.cbs_vacancy_rate (
              period_key TEXT NOT NULL,
              period_label TEXT,
              sector_name TEXT,
              vacancies DOUBLE PRECISION,
        ...
        cur.execute(
            """
            CREATE TABLE IF NOT EXISTS odp_staffing_demand.uwv_vacancies (
...
def run_odp_staffing_demand_postgres_pipeline() -> None:
    ...
    print(
        "[Job Market Postgres] ✓ Refreshed odp_staffing_demand.it_market_snapshot, "
        "odp_staffing_demand.it_market_top_skills, odp_staffing_demand.it_market_region_distribution, and "
        "odp_staffing_demand.it_market_job_ads_geo "
