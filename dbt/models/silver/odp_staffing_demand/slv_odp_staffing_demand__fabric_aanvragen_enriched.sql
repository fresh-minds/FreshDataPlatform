-- slv_odp_staffing_demand__fabric_aanvragen_enriched.sql
...
with aanvragen as (
    ...
    select * from {{ ref('brz_odp_staffing_demand__fl_fact_aanvragen') }}
...
roles as (
    ...
    from {{ ref('brz_odp_staffing_demand__fl_dim_rol') }}
