-- slv_odp_staffing_demand__sector_vacancy_enriched.sql
-- Silver model: enrich the snapshot with regional and skills context.
...
skills as (
    ...
    from {{ ref('brz_odp_staffing_demand__it_market_top_skills') }}
