-- brz_odp_staffing_demand__it_market_snapshot.sql
-- Bronze model: type-cast and rename source columns for downstream use.

with source as (

    select * from {{ source('odp_staffing_demand', 'it_market_snapshot') }}
